...
export default function RajinderNagarPricing() {
  return (
    <section className={styles.pricing}>
      <div className={styles.container}>
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <span className={styles.badge}>Rajinder Nagar Pricing</span>
          <h2>Home Tuition Fees in Rajinder Nagar, Central Delhi</h2>
