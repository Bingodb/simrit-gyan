...
import styles from './RajinderNagarHero.module.css'
...
const AREAS = [
  ...
  'Gole Market', 'Mandir Marg', 'RK Ashram Marg', 'Other Central Delhi Area'
]

export default function RajinderNagarHero() {
    ...
    <section className={styles.hero}>
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          >
            <MapPin size={16} />
            <span>Rajinder Nagar, Central Delhi</span>
          </motion.div>
          ...
          >
            ...
            <span>4.9★ · 350+ Reviews · Trusted in Central Delhi</span>
          </motion.div>
          ...
          >
            Best Home Tuition in Rajinder Nagar — All Central Delhi Areas Covered
          </motion.h1>
          ...
          >
            180+ verified home tutors in Rajinder Nagar, Karol Bagh, Patel Nagar, Connaught Place. Class 1-12, JEE, NEET. Free demo at your doorstep.
          </motion.p>
          ...
          >
            ...
            <div className={styles.feature}>
              <CheckCircle size={18} />
              <span>All Central Delhi Localities</span>
            </div>
            <div className={styles.feature}>
              <CheckCircle size={18} />
          ...
          >
            ...
            <a href="https://wa.me/918368653414" target="_blank" rel="noopener noreferrer" className={styles.secondaryBtn}>
          ...
          {!submitted ? (
            <>
              <div className={styles.formHeader}>
                ...
                <div>
                  <h3>Book Free Demo in Rajinder Nagar</h3>
              ...
              <form onSubmit={handleSubmit} className={styles.form}>
                ...
                <select name="area" value={formData.area} onChange={handleChange} required>
                  <option value="">Your Area in Central Delhi *</option>
                  {AREAS.map(area => (
            ...
            <div className={styles.successMessage}>
              ...
              <p>Our Central Delhi counselor will call you within 30 minutes.</p>
              <a href="tel:+918368653414" className={styles.callBtn}>
                <Phone size={18} />
                Call Now
              </a>
            </div>
