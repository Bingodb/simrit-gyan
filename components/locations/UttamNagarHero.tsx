...
import styles from './UttamNagarHero.module.css'

const AREAS = [
  'Uttam Nagar East', 'Uttam Nagar West', 'Nawada', 'Dwarka Mor',
  'Janakpuri', 'Janakpuri East', 'Janakpuri West', 'Vikaspuri',
  'Tilak Nagar', 'Subhash Nagar', 'Tagore Garden', 'Rajouri Garden',
  'Moti Nagar', 'Kirti Nagar', 'Ramesh Nagar', 'Shadipur',
  'Patel Nagar', 'Punjabi Bagh', 'Paschim Vihar', 'Other West Delhi Area'
]

export default function UttamNagarHero() {
    ...
    <section className={styles.hero}>
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          >
            <MapPin size={16} />
            <span>Uttam Nagar, West Delhi</span>
          </motion.div>
          ...
          >
            ...
            <span>4.8★ · 410+ Reviews · Trusted in West Delhi</span>
          </motion.div>
          ...
          >
            Best Home Tuition in Uttam Nagar — All West Delhi Areas Covered
          </motion.h1>
          ...
          >
            250+ verified home tutors in Uttam Nagar, Janakpuri, Dwarka Mor, Tilak Nagar, Vikaspuri. Class 1-12, JEE, NEET. Free demo at your doorstep.
          </motion.p>
          ...
          >
            ...
            <div className={styles.feature}>
              <CheckCircle size={18} />
              <span>All West Delhi Localities</span>
            </div>
            <div className={styles.feature}>
              <CheckCircle size={18} />
          ...
          >
            ...
            <a href="https://wa.me/917503219801" target="_blank" rel="noopener noreferrer" className={styles.secondaryBtn}>
          ...
          {!submitted ? (
            <>
              <div className={styles.formHeader}>
                ...
                <div>
                  <h3>Book Free Demo in Uttam Nagar</h3>
              ...
              <form onSubmit={handleSubmit} className={styles.form}>
                ...
                <select name="area" value={formData.area} onChange={handleChange} required>
                  <option value="">Your Area in West Delhi *</option>
                  {AREAS.map(area => (
            ...
            <div className={styles.successMessage}>
              ...
              <p>Our West Delhi counselor will call you within 30 minutes.</p>
